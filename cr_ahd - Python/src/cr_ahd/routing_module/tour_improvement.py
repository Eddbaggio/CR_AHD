...
class TourImprovementBehavior(ABC):
    ...
    @abstractmethod
    def improve_instance(self, instance: it.PDPInstance, solution: slt.GlobalSolution):
        pass

    @abstractmethod
    def improve_carrier(self, instance: it.PDPInstance, solution: slt.GlobalSolution, carrier: int):
        pass
...
class TwoOpt(TourImprovementBehavior):
    ...
    def improve_instance(self, instance: it.PDPInstance, solution: slt.GlobalSolution):
        for carrier in range(instance.num_carriers):
            self.improve_carrier(instance, solution, carrier)
        pass
        ...
        for old_tour in range(cs.num_tours()):
            ...
            while improved:
                ...
                for pickup_position in range(1, len(cs.tours[old_tour])-2):
                    ...
                    savings = cs.tours[old_tour].removal_distance_savings(instance,
        ...
        for new_tour in range(cs.num_tours()):
            ...
            for i in range(1, len(cs.tours[new_tour]) - 1):
                for j in range(i + 1, len(cs.tours[new_tour])):
                    delta = cs.tours[new_tour].insertion_distance_cost(instance, [i, j],
