...
def test__tour_cheapest_insertion(inst_and_sol_gh_0_ass9_routed6):
    ...
    assert cns.CheapestPDPInsertion().best_insertion_for_carrier(instance, solution, 0, solution.carriers[
        0].unrouted_requests) == (2, 0, 1, 6)

    cns.CheapestPDPInsertion().execute_insertion(instance, solution, 0, 2, 0, 1, 6)
