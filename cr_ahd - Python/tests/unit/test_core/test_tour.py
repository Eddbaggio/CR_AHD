...
# def test_removal_distance_delta(inst_and_sol_gh_0_9_ass_6_routed):
...
def test__insert_no_update(inst_and_sol_gh_0_9_ass_6_routed):
    instance: it.PDPInstance
    solution: slt.GlobalSolution
    instance, solution = inst_and_sol_gh_0_9_ass_6_routed
    c = 0
...
# def test_insertion_distance_delta(inst_and_sol_gh_0_9_ass_6_routed):
#     instance: it.PDPInstance
#     solution: slt.GlobalSolution
#     instance, solution = inst_and_sol_gh_0_9_ass_6_routed
#     c = 0
...
def test_insert_and_update(inst_and_sol_gh_0_9_ass_6_routed):
    instance: it.PDPInstance
    solution: slt.GlobalSolution
    instance, solution = inst_and_sol_gh_0_9_ass_6_routed
    c = 0
...
def test__pop_no_update(inst_and_sol_gh_0_9_ass_6_routed):
    instance: it.PDPInstance
    solution: slt.GlobalSolution
    instance, solution = inst_and_sol_gh_0_9_ass_6_routed
    c = 0
...
def test__pop_and_update(inst_and_sol_gh_0_9_ass_6_routed):
    instance: it.PDPInstance
    solution: slt.GlobalSolution
    instance, solution = inst_and_sol_gh_0_9_ass_6_routed
    c = 0
