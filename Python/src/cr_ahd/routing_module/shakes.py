...
class Shake(ABC):
    ...
    @abstractmethod
    def execute(self, instance: it.CAHDInstance, carrier: slt.AHDSolution, num_requests: int):
        """
    ...
    @abstractmethod
    def execute_on_tour(self, instance: it.CAHDInstance, tour: tr.Tour, num_requests: int):
        """
